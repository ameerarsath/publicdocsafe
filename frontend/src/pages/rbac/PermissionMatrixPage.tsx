                ...
                <div className="flex">
                  ...
                  <div className="ml-3">
                    ...
                    <div className="mt-2 text-sm text-yellow-700">
                      <p>
                        You need administrator privileges (hierarchy level 4 or higher) to access the permission matrix.
                        Current user: {user?.username || 'Unknown'}, Role: {user?.role || 'Unknown'}
                      </p>
                    </div>
                  </div>
                </div>
